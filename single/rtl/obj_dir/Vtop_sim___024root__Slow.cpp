...
void Vtop_sim___024root___ctor_var_reset(Vtop_sim___024root* vlSelf) {
    ...
    vlSelf->ex_alu_rd_wdata_o = VL_RAND_RESET_Q(64);
    vlSelf->ex_agu_mem_addr_o = VL_RAND_RESET_Q(64);
    ...
    vlSelf->top_sim__DOT__ex_alu_rd_wdata = VL_RAND_RESET_Q(64);
    ...
    vlSelf->top_sim__DOT__u_wb__DOT__mem_rd_wdata_i = VL_RAND_RESET_Q(64);
    vlSelf->top_sim__DOT__u_wb__DOT__csr_rd_wdata_i = VL_RAND_RESET_Q(64);
